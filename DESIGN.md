...
- Richer scripting in the editor: syntax and error feedback on a script as you type, and a more discoverable script API surface than the current flat variable names (see Open questions).
