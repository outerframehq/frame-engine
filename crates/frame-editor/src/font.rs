// A tiny hand-rolled bitmap font for the editor's text overlays.
//
...
// bit 0 the rightmost. A set bit = a lit pixel. Unknown chars (incl. space)
// render blank.
//
// Covers the full uppercase alphabet, digits, and a little punctuation — enough
// for the inspector (ID / POS / VEL + numbers) and the controls overlay.
